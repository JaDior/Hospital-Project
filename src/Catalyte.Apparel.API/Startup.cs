    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ApparelCtx db)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "Catalyte.Apparel.API v1");
                    c.RoutePrefix = string.Empty; //modified 1/27/2022 as per docs.microsoft tip for adding swagger
                    });
